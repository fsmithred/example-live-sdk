...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/4.9/include'
...
grub_package="grub"
grub_package_string="GRUB 2.02~beta2-22+deb8u1"
grub_package_version="2.02~beta2-22+deb8u1"
